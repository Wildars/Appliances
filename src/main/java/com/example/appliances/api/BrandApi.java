...
public class BrandApi {
    ...
    @PostMapping("/create")
    public ResponseEntity<BrandResponse> createProductField(@RequestBody BrandRequest request) {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<BrandResponse> getProductFieldById(@PathVariable Long id) {
    ...
    @GetMapping("/list")
    public ResponseEntity<List<BrandResponse>> getAllProductFields() {
        List<BrandResponse> products = brandService.findAll();
        return new ResponseEntity<>(products, HttpStatus.OK);
    }
    @PutMapping("/{id}")
    public ResponseEntity<BrandResponse> updateProductField(@RequestBody BrandRequest request, @PathVariable Long id) {
